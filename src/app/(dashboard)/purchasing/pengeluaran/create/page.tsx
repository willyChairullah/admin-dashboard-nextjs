    ...
    async function loadData() {
      try {
        ...
        setFormData(prev => ({
          ...prev,
          code: codeData,
          createdBy: user?.id || "", // Automatically set creator to current user
        }));
      } catch (error) {
      ...
      <div className="p-3 md:px-28 md:py-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Basic Information */}
            <FormField label="Kode Pengeluaran" errorMessage={formErrors.code}>
              <Input
                type="text"
                name="code"
                value={formData.code}
            ...
            <FormField label="Tanggal Bayar" errorMessage={formErrors.dueDate}>
              <InputDate
            ...
            >
              <Input
                type="text"
                name="createdBy"
                value={availableUsers.find(u => u.id === user?.id)?.name || user?.name || 'User not found'}
                disabled={true}
                          ...
                          <td className="border border-gray-200 dark:border-gray-600 px-2 py-2">
                            <div className="relative">
                              ...
                              <Input
                                ...
                                className="pl-10 text-right text-m py-1"
                                placeholder="0"
