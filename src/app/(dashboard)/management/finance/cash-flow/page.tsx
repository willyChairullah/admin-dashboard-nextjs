...
export default function CashFlowDashboard() {
  ...
  const [activeView, setActiveView] = useState<"overview" | "analysis" | "forecast" | "transactions">("overview");

  useEffect(() => {
    const loadData = async () => {
      setLoading(true);
      try {
        const response = await fetch(`/api/finance/cash-flow?timeRange=${timeRange}`);
        if (response.ok) {
          ...
          setData({
            ...
            monthly: [
              { month: "Jan", cashIn: 650000000, cashOut: 580000000, netFlow: 70000000, balance: 720000000 },
              { month: "Feb", cashIn: 680000000, cashOut: 620000000, netFlow: 60000000, balance: 780000000 },
              { month: "Mar", cashIn: 720000000, cashOut: 650000000, netFlow: 70000000, balance: 850000000 },
              { month: "Apr", cashIn: 750000000, cashOut: 680000000, netFlow: 70000000, balance: 920000000 },
              { month: "May", cashIn: 780000000, cashOut: 710000000, netFlow: 70000000, balance: 990000000 },
              { month: "Jun", cashIn: 820000000, cashOut: 740000000, netFlow: 80000000, balance: 1070000000 },
            ],
            categories: {
              inflows: [
                { category: "Sales Revenue", amount: 680000000, percentage: 68, trend: 12.5, icon: "DollarSign" },
                { category: "Account Receivables", amount: 180000000, percentage: 18, trend: 8.2, icon: "CreditCard" },
                { category: "Investment Returns", amount: 80000000, percentage: 8, trend: 15.3, icon: "TrendingUp" },
                { category: "Other Income", amount: 60000000, percentage: 6, trend: 5.1, icon: "Wallet" },
              ],
              outflows: [
                { category: "Operating Expenses", amount: 420000000, percentage: 42, trend: -2.3, icon: "Building" },
                { category: "Inventory Purchases", amount: 280000000, percentage: 28, trend: 4.2, icon: "Package" },
                { category: "Payroll & Benefits", amount: 150000000, percentage: 15, trend: 3.1, icon: "Users" },
                { category: "Loan Payments", amount: 80000000, percentage: 8, trend: -1.5, icon: "CreditCard" },
                { category: "Other Expenses", amount: 70000000, percentage: 7, trend: 2.8, icon: "Activity" },
              ],
            },
            forecast: [
              { period: "Next Month", projected: 85000000, conservative: 70000000, optimistic: 100000000 },
              { period: "Q2 2025", projected: 250000000, conservative: 200000000, optimistic: 300000000 },
              { period: "Q3 2025", projected: 280000000, conservative: 230000000, optimistic: 330000000 },
              { period: "Q4 2025", projected: 320000000, conservative: 270000000, optimistic: 370000000 },
            ],
            analysis: {
              liquidityRatio: 2.8,
              burnRate: 15000000,
            ...
            transactions: [
              { id: "1", date: "2025-07-27", description: "Customer Payment - PT ABC", category: "Sales Revenue", amount: 45000000, type: "INFLOW", status: "Completed" },
              { id: "2", date: "2025-07-27", description: "Inventory Purchase - Oil Supplies", category: "Inventory", amount: -25000000, type: "OUTFLOW", status: "Completed" },
              { id: "3", date: "2025-07-26", description: "Payroll Processing", category: "Payroll", amount: -18000000, type: "OUTFLOW", status: "Completed" },
              { id: "4", date: "2025-07-26", description: "Investment Dividend", category: "Investment", amount: 12000000, type: "INFLOW", status: "Completed" },
              { id: "5", date: "2025-07-25", description: "Office Rent Payment", category: "Operating", amount: -8000000, type: "OUTFLOW", status: "Completed" },
            ],
          });
        }
      } catch (error) {
  ...
  const handleExportData = () => {
    ...
    if (link.download !== undefined) {
      ...
      link.setAttribute("download", `cash_flow_${timeRange}_${new Date().toISOString().split('T')[0]}.csv`);
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center text-emerald-600">
                ...
                <span className="text-sm font-medium">
                  {((data.summary.currentBalance - data.summary.previousBalance) / data.summary.previousBalance * 100).toFixed(1)}%
                </span>
              </div>
            </div>
        ...
        <Card className="p-3 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-0 shadow-xl">
          <div className="flex space-x-2 overflow-x-auto">
            {[
              ...
              { key: "forecast", label: "Forecast & Projections", icon: TrendingUp },
              { key: "transactions", label: "Recent Transactions", icon: Activity },
            ...
            <Card className="p-8 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-0 shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl">
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-1">Avg Monthly Inflow</p>
                  <p className="text-xl font-bold text-green-600">
                    {formatRupiah(data.monthly.reduce((sum, m) => sum + m.cashIn, 0) / data.monthly.length)}
                  </p>
                </div>
                
                <div className="p-4 bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 rounded-xl">
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-1">Avg Monthly Outflow</p>
                  <p className="text-xl font-bold text-red-600">
                    {formatRupiah(data.monthly.reduce((sum, m) => sum + m.cashOut, 0) / data.monthly.length)}
                  </p>
                </div>
                
                <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl">
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-1">Avg Net Flow</p>
                  <p className="text-xl font-bold text-blue-600">
                    {formatRupiah(data.monthly.reduce((sum, m) => sum + m.netFlow, 0) / data.monthly.length)}
                  </p>
                </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200 dark:border-gray-700">
                      ...
                      <th className="text-right py-4 px-6 font-semibold text-gray-900 dark:text-white">Cash In</th>
                      <th className="text-right py-4 px-6 font-semibold text-gray-900 dark:text-white">Cash Out</th>
                      <th className="text-right py-4 px-6 font-semibold text-gray-900 dark:text-white">Net Flow</th>
                      <th className="text-right py-4 px-6 font-semibold text-gray-900 dark:text-white">Balance</th>
                    </tr>
                  </thead>
                  <tbody>
                    {data.monthly.map((month) => (
                      <tr key={month.month} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/50">
            ...
            <Card className="p-8 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-0 shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {data.categories.inflows.map((category, index) => {
                  ...
                  return (
                    <div key={index} className="p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center">
            ...
            <Card className="p-8 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-0 shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {data.categories.outflows.map((category, index) => {
                  const IconComponent = getIconComponent(category.icon);
                  return (
                    <div key={index} className="p-6 bg-gradient-to-br from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 rounded-xl">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className={`text-sm font-medium ${category.trend >= 0 ? 'text-red-600' : 'text-green-600'}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              <div className="space-y-4">
                ...
                {data.forecast.map((forecast, index) => (
                  <div key={index} className="p-6 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-xl">
                    <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600 dark:text-gray-300">Projected</span>
                        <span className="font-bold text-indigo-600">
                          {formatRupiah(forecast.projected)}
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600 dark:text-gray-300">Optimistic</span>
                    ...
                    <div className="mt-4 space-y-2">
                      <div className="bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        <div 
                          ...
                          style={{ width: `${(forecast.projected / forecast.optimistic) * 100}%` }}
                        ></div>
                      </div>
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        {((forecast.projected / forecast.optimistic) * 100).toFixed(0)}% of optimistic scenario
                      </p>
                    </div>
                  </div>
                ))}
              ...
              <div className="space-y-6">
                <div className="p-6 bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 rounded-xl">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-300">Burn Rate</span>
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-300">Seasonality</span>
                ...
                <div className="p-6 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-xl">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                    <li>• Maintain current cash position for optimal liquidity</li>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    ...
                    <th className="text-right py-4 px-6 font-semibold text-gray-900 dark:text-white">Amount</th>
                    ...
                    <tr key={transaction.id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                      ...
                      <td className="py-4 px-6 text-right font-bold">
                        <span className={transaction.type === 'INFLOW' ? 'text-green-600' : 'text-red-600'}>
                          {transaction.type === 'INFLOW' ? '+' : ''}{formatRupiah(transaction.amount)}
                        </span>
                      </td>
