            ...
            <div className="space-y-4 lg:space-y-0 lg:flex lg:items-center lg:justify-between">
              ...
              <div className="flex items-start sm:items-center">
                ...
                <div className="flex items-start sm:items-center min-w-0 flex-1">
                  <div className="p-2 sm:p-3 lg:p-4 bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-2xl lg:rounded-3xl mr-3 sm:mr-4 lg:mr-6 flex-shrink-0">
                    <Wallet className="h-5 w-5 sm:h-6 sm:w-6 lg:h-8 lg:w-8 xl:h-10 xl:w-10 text-white" />
                  </div>
              ...
              <div className="flex flex-col xs:flex-row gap-2 sm:gap-3 lg:gap-4 lg:flex-shrink-0">
                    ...
                    {(["month", "quarter", "year"] as const).map((range) => (
                      ...
                      >
                        {loading && timeRange === range && (
                          <div className="animate-spin rounded-full h-3 w-3 border-b-2 border-cyan-600 mr-1"></div>
                        )}
                ...
                <button
                  ...
                  className="bg-white/10 backdrop-blur-sm text-white px-3 sm:px-4 lg:px-6 py-1.5 sm:py-2 lg:py-3 rounded-lg sm:rounded-xl lg:rounded-2xl hover:bg-white/20 transition-all duration-200 flex items-center justify-center text-xs sm:text-sm lg:text-base flex-shrink-0"
                >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
          ...
          <Card className="p-4 sm:p-6 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-0 shadow-xl">
            <div className="flex items-center justify-between mb-3 sm:mb-4">
              <Wallet className="h-6 w-6 sm:h-8 sm:w-8 text-emerald-600" />
            ...
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 dark:text-white leading-tight break-words">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <Card className="p-4 sm:p-6 lg:p-8 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-0 shadow-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
                ...
                <div className="p-3 sm:p-4 bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 rounded-lg sm:rounded-xl">
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 mb-1">
                    Avg Monthly Outflow
                  </p>
                ...
                <div className="p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg sm:rounded-xl">
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 mb-1">
                    Avg Net Flow
                  </p>
                ...
                <div className="p-3 sm:p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg sm:rounded-xl">
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 mb-1">
                    Growth Rate
                  </p>
                    ...
                    <tbody>
                      {data.monthly.map((month) => (
                        ...
                        >
                          ...
                          <td className="py-3 sm:py-4 px-3 sm:px-6 text-right font-semibold text-red-600 text-sm sm:text-base">
                            {formatRupiah(month.cashOut)}
                          </td>
                          <td className="py-3 sm:py-4 px-3 sm:px-6 text-right font-semibold">
                            <span
                              className={
                                month.netFlow >= 0
                                  ? "text-green-600"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                {data.categories.inflows.map((category, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="p-4 sm:p-6 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg sm:rounded-xl"
                    >
                      <div className="flex items-center justify-between mb-3 sm:mb-4">
                        <div className="flex items-center min-w-0 flex-1">
                          <IconComponent className="h-6 w-6 sm:h-8 sm:w-8 text-green-600 mr-2 sm:mr-3 flex-shrink-0" />
                          <h4 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-800 dark:text-gray-200 truncate">
                            {category.category}
                          </h4>
                        </div>
                      ...
                      <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 dark:text-white mb-2 break-words">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {data.categories.outflows.map((category, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="p-4 sm:p-6 bg-gradient-to-br from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 rounded-lg sm:rounded-xl"
                    >
                      <div className="flex items-center justify-between mb-3 sm:mb-4">
                        <div className="flex items-center min-w-0 flex-1">
                          <IconComponent className="h-5 w-5 sm:h-6 sm:w-6 text-red-600 mr-2 flex-shrink-0" />
                          <h4 className="text-xs sm:text-sm lg:text-base font-semibold text-gray-800 dark:text-gray-200 truncate">
                            {category.category}
                          </h4>
                        </div>
                        <div className="flex items-center flex-shrink-0">
                      ...
                      <p className="text-base sm:text-lg lg:text-xl font-bold text-gray-900 dark:text-white mb-2 break-words">
                        {formatRupiah(category.amount)}
                      </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
              <div className="space-y-3 sm:space-y-4">
                ...
                {data.forecast.map((forecast, index) => (
                  <div
                    key={index}
                    className="p-4 sm:p-6 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-lg sm:rounded-xl"
                  >
                    <div className="flex items-center justify-between mb-3 sm:mb-4">
                      <h5 className="text-sm sm:text-base lg:text-lg font-semibold text-gray-800 dark:text-gray-200 truncate">
                        {forecast.period}
                      </h5>
                    ...
                    <div className="space-y-2 sm:space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold text-green-600 text-xs sm:text-sm break-words">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="p-4 sm:p-6 bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 rounded-lg sm:rounded-xl">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm sm:text-lg lg:text-xl font-bold text-gray-900 dark:text-white break-words">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm sm:text-lg lg:text-xl font-bold text-cyan-600">
                ...
                <div className="p-4 sm:p-6 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-lg sm:rounded-xl">
                  <h4 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-200 mb-3 sm:mb-4">
                    Recommendations
                  </h4>
        ...
        {activeView === "transactions" && (
          <Card className="p-4 sm:p-6 lg:p-8 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-0 shadow-xl">
            <div className="flex flex-col xs:flex-row xs:items-center justify-between mb-4 sm:mb-6 gap-3 xs:gap-0">
              ...
              <button className="flex items-center justify-center px-3 sm:px-4 py-2 bg-cyan-600 text-white rounded-lg hover:bg-cyan-700 transition-colors duration-200 text-sm sm:text-base">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    ...
                    <th className="text-center py-3 sm:py-4 px-3 sm:px-6 font-semibold text-gray-900 dark:text-white text-sm sm:text-base">
                      Status
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {data.transactions.map((transaction) => (
                    <tr
                      ...
                      className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/50"
                    >
                      <td className="py-3 sm:py-4 px-3 sm:px-6 text-gray-900 dark:text-white text-sm sm:text-base">
                        {new Date(transaction.date).toLocaleDateString()}
                      </td>
                      ...
                      <td className="py-3 sm:py-4 px-3 sm:px-6">
                        <span className="px-2 sm:px-3 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded-full text-xs sm:text-sm">
                          {transaction.category}
                        </span>
                      </td>
                      <td className="py-3 sm:py-4 px-3 sm:px-6 text-right font-bold">
                        <span
                      ...
                      <td className="py-3 sm:py-4 px-3 sm:px-6 text-center">
                        <span className="px-2 sm:px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 rounded-full text-xs sm:text-sm">
                          {transaction.status}
                        </span>
                      </td>
                    </tr>
