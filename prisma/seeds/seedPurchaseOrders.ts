  ...
  const purchaseOrdersData = [
    {
      ...
      dateline: new Date("2025-02-15"),
      code: "PO-2025-001",
      totalAmount: 2500000,
      orderId: createdOrders[0].id,
      statusStockConfirmation: "WAITING_CONFIRMATION" as const,
    ...
    },
    {
      ...
      creatorId: adminUser.id,
      dateline: new Date("2025-02-20"),
      code: "PO-2025-002",
      totalAmount: 3750000,
      orderId: createdOrders[1].id,
      dateStockConfirmation: new Date("2025-01-21"),
      notesStockConfirmation: "Stok tersedia, siap diproses",
      statusStockConfirmation: "STOCK_AVAILABLE" as const,
      userStockConfirmationId: warehouseUser.id,
    ...
    },
    {
      ...
      creatorId: adminUser.id,
      dateline: new Date("2025-02-25"),
      code: "PO-2025-003",
      totalAmount: 5000000,
      orderId: createdOrders[2].id,
      dateStockConfirmation: new Date("2025-01-26"),
      notesStockConfirmation: "Barang telah disiapkan dan siap kirim",
      statusStockConfirmation: "STOCK_AVAILABLE" as const,
      userStockConfirmationId: warehouseUser.id,
    ...
    },
    {
      ...
      creatorId: adminUser.id,
      dateline: new Date("2025-02-28"),
      code: "PO-2025-004",
      totalAmount: 1875000,
      orderId: createdOrders[3].id,
      dateStockConfirmation: new Date("2025-01-31"),
      notesStockConfirmation: "Pengiriman telah selesai",
      statusStockConfirmation: "STOCK_AVAILABLE" as const,
      userStockConfirmationId: warehouseUser.id,
